...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            DownloadUserAccountsTask task = new DownloadUserAccountsTask();
...
//            mAuthTask.execute((Void) null);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                ...
                // Select only login_email_text addresses.
                ContactsContract.Contacts.Data.MIMETYPE +
                        " = ?", new String[]{ContactsContract.CommonDataKinds.Email
                                                                     .CONTENT_ITEM_TYPE},

                // Show primary login_email_text addresses first. Note that there won't be
                // a primary login_email_text address if the user hasn't specified one.
    ...
    private class DownloadUserAccountsTask extends AsyncTask<String, Void, String> {
